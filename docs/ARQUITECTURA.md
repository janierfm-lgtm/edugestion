...
- El **código de la aplicación** (backend y frontend) sí se ejecutó, probó y verificó de extremo a extremo de forma real: las 23 pruebas automatizadas con Jest pasan, y se verificó manualmente con una colección de Postman (18 peticiones) contra el backend corriendo con una base de datos PostgreSQL real.
